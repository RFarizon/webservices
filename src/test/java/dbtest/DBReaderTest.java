...
public class DBReaderTest {
  ...
  public void testSelectProperty() {
    ...
    /*
     * Check for the following: 1.) that the list is actually populated with Properties, and not
     * nulls, 2.) that all the Properties have zpids. 3.) That the addresses match what we queried
     * for 4.) That the zip codes match what we queried for
     */
